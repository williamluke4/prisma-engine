...
#[test_each_connector]
async fn last_should_return_none_if_there_is_no_migration(_: &TestSetup, api: &dyn GenericApi) {
...
#[test_each_connector]
async fn last_must_return_none_if_there_is_no_successful_migration(_: &TestSetup, api: &dyn GenericApi) {
    let persistence = api.migration_persistence();
...
#[test_each_connector]
async fn load_all_should_return_empty_if_there_is_no_migration(_: &TestSetup, api: &dyn GenericApi) {
    let persistence = api.migration_persistence();
